...
void oLog::Init(int32 fileLogLevel, LogType logType)
{
	...
	switch(logType)
	{
		case TESTGAME_LOG:
			{
				logNormalFilename = "test-normal.log";
				logErrorFilename = "test-error.log";
				break;
			}
		case ACCOUNTMEM_LOG:
			{
				logNormalFilename = "accountmem-normal.log";
				logErrorFilename = "accountmem-error.log";
				break;
			}
		case GAMEFRAME_LOG:
			{
				logNormalFilename = "gameframe-normal.log";
				logErrorFilename = "gameframe-error.log";
				break;
			}
